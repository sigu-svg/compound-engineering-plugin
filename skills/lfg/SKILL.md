...
When that intent exists, remove the implementation-routing directive from the feature request that enters planning and retain one transient `implementation_engine` object with exactly these four fields:

...
- **P2** — `skills/ce-explain/SKILL.md:70` — Predict-then-reveal protocol duplicated with only substring guard — filed: https://github.com/sigu-svg/compound-engineering-plugin/issues/1057 (resolution is keep-both-plus-parity-guard per AGENTS.md inline-the-trigger doctrine; the reviewer's trim-to-pointer fix was rejected by validation)

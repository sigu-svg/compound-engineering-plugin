...
- Issue: `sigu-svg/compound-engineering-plugin#1131`; regression window v3.15.0–v3.17.1 (plan unification `7ef752aa`, cross-model review pass `fdfad38b`, verification-evidence retry `9bc6713c`).

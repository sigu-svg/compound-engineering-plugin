...
To pin a release, add a tag. Replace `X.Y.Z` with the release you want — see the [releases page](https://github.com/sigu-svg/compound-engineering-plugin/releases) for available tags:

```json
{
  "plugin": ["compound-engineering@git+https://github.com/sigu-svg/compound-engineering-plugin.git#compound-engineering-vX.Y.Z"]
}
```
